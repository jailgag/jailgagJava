...
public class StudentArray {
	public static void main(String[] args) {
		Student [] students = new Student[3];  //<---대문자s구분~~!!!+student를 
		students[0] = new Student("일용자", 99, 88, 77);     // <------- 생략
		//		students [0] = new Student();          //<---students로 바꿈!!!!
//		students[0].name = "일용자";
//		students[0].kor = 99;
//		students[0].eng = 88;
//		students[0].math= 77;
